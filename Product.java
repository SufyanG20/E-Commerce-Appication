...
public class Product {
	...
	public Product(String id) {
		this(id, "Product", 0, 0, Category.GENERAL);
	}
	...
	public boolean validOptions(String productOptions) {
		// Modified the method so that a book or shoe can not be ordered using the
		// regular ORDER command
		if (productOptions.equals("") || productOptions.equals(null)) {
			return true;
		}
		return false;
	}

	// Various settor and getter methods needed for the Product class
